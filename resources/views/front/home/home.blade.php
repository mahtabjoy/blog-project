                ...
                <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                    <div class="card text-center">
                        ...
                        <div class="card-body p-0">
                            ...
                            <a href="{{ route('service-details', ['slug' => $service->slug] ) }}" class="btn btn-secondary translateY-25">Read More</a>
                        </div>
                    </div>
                </div>
                @endforeach
        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-sm-6 mb-4 mb-lg-0">
                    <div class="card">
                        <img class="card-img-top" src="{{ asset($article->image) }}" alt="news-thumbnail" style="height: 200px">
                        <div class="card-body p-0">
                            <div class="p-3 border-bottom">
                                <h6 class="text-primary">{{ $article->updated_at->format('M d,Y') }}</h6>
                                <a href="{{ route('article-details', ['slug' => $article->slug]) }}" class="h4 card-title font-primary text-dark">{{ $article->art_title }}</a>
                                <p class="card-text">{!!  \Illuminate\Support\Str::words($article->description, 50) !!}</p>
                            </div>
